...
class SoT:
    def __init__(self, dataset = 'gsm8k', exp_type = 'only_uncertainty'):
        ...
        self.__CONTEXT_PATH_BASE = os.path.join(str(default_path()), f"../demos_generated/demos/{exp_type}/manual_checked_all_datasets_structed.json")
