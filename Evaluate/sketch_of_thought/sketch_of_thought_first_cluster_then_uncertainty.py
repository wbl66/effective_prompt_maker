...
class SoT:
    def __init__(self, dataset='gsm8k'):
        ...
        self.__CONTEXT_PATH_BASE = os.path.join(str(default_path()), f"../demos_generated/demos/first_cluster_then_uncertainty/manual_checked_{dataset}_structed.json")
    ...
    def get_initialized_context(self, paradigm, question=None, image_data=None, language_code="EN", include_system_prompt=True, label=None, format="llm"):
        ...
        :param label: The cluster label for the question.
